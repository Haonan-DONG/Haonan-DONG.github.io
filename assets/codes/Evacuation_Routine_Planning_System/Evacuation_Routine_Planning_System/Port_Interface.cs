...
namespace SerialPortConnection
{
    public partial class Port_Form : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            // here how to transmit the route. need read the text.
        ...
        //开关按钮
        // here we need an automatic thread to read the data from textbox and to write file.
        private void btnSwitch_Click(object sender, EventArgs e)
        {

            // new thread.
            readFileThread=new Thread(ReadDataThread)
            {
                Name = "ReadDataThread",
                IsBackground = true   // which means when the main closed, this will end.
            };
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            while(readFileThread.ThreadState!=ThreadState.Aborted)
            {
                txtReceive.Text = "It is not over!";
            }
        }
        ...
        // ---------------------------- auxiliary function -------------------------------
        // --- read data ---
        // time to read the txt.
        public void ReadDataThread()
        {
            t = new System.Timers.Timer(3000);   // 3s
            t.Elapsed += new System.Timers.ElapsedEventHandler(ReadDataFromPortFunction);
            t.AutoReset = true;
            t.Enabled = true;
        }

        // Write file.
        public void ReadDataFromPortFunction(object source, System.Timers.ElapsedEventArgs e)
        {
            // write file and the readers.
            string str = txtReceive.Text;
            // if text the context then t stop.!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            StreamWriter sw1 = new StreamWriter(@"E:\Wuhan_University\Research\Sentific_Research\Evacuation_System\Junior_2nd\Program\Evacuation_Routine_Planning_System\data_raw.txt",true);
            sw1.WriteLine(str);
            txtReceive.Text = "";
            sw1.Close();
        }
